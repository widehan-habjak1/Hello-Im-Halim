(() => {
    ...
    const messages = [
        ...
        ["A Korean-born Indonesian Muslim student building a career portfolio through programming, science, languages, and creative projects.", "한국에서 태어난 인도네시아 무슬림 학생으로 프로그래밍과 과학, 언어, 창작 프로젝트를 통해 진로 포트폴리오를 쌓아가고 있다."],
        ["View Profile", "프로필 보기"],
        ["See Work", "프로젝트 보기"],
        ["Scroll down", "아래로"],
        ["Latest", "최근 소식"],
        ...
        ["I study in Korea while keeping my Indonesian identity close. My goal is to grow into a creator who can connect technology, learning, and real people.", "인도네시아인으로서의 정체성을 간직하며 한국에서 초-중-고등학교에 다니고 있다,. 배움과 지식, 사람을 연결하는 창작자로 성장하고 싶다."],
        ["Languages", "사용 언어"],
        ["Portfolio Works", "포트폴리오 작품"],
        ["Career Growth", "진로 성장"],
        ["Strength", "강점"],
        ["Personal Traits", "나의 강점"],
        ...
        ["Strong curiosity around physics concepts, algorithms, and systems.", "물리 개념과 알고리즘, 시스템의 원리에 깊은 호기심을 갖고 있습니다."],
        ["Language Skills", "언어 능력"],
        ["Fluent in Indonesian, English, and Korean.", "인도네시아어, 영어, 한국어를 유창하게 사용합니다."],
        ["Timeline", "타임라인"],
        ["Career exploration started", "진로 탐색 시작"],
        ["Web development interest became stronger", "웹 개발에 대한 관심이 깊어짐"],
        ["React learning began", "React 학습 시작"],
        ["First project experience", "첫 프로젝트 경험"],
        ["AI and computer science exploration", "AI와 컴퓨터공학 탐구"],
        ...
        ["Traits", "나의 성향"],
        ["Curious, multilingual, persistent, and comfortable learning new tools. I like turning rough ideas into something people can actually use.", "호기심이 많고 여러 언어를 사용하며, 끈기 있게 새로운 도구를 배웁니다. 막연한 아이디어를 사람들이 실제로 사용할 수 있는 결과물로 만드는 일을 좋아한다."],
        ["Vision", "나의 목표"],
        ["My goal is to enter a top university and build skills in computer science, AI, and meaningful technology for people.", "우수한 대학에 진학해 컴퓨터공학과 AI 역량을 키우고, 사람들에게 도움이 되는 기술을 만드는 것이 목표입니다."],
        ["Interests", "관심 분야"],
        ["#History", "#역사"],
        ...
        ["History Enthusiast", "역사에 대한 관심"],
        ["Interested in history knowledge, especially Korean history.", "역사, 특히 한국사에 관심이 많습니다."],
        ...
        ["Skills", "기술 역량"],
        ["Certificates", "자격증"],
        ["Outstanding achievement", "우수한 성적"],
        ["ITQ PowerPoint", "ITQ 파워포인트"],
        ["Computer Literacy", "컴퓨터활용능력"],
        ["Level 2", "2급"],
        ["More Growth", "앞으로의 성장"],
        ...
        ["Awards", "수상 내역"],
        ["School", "학교"],
        ["선린인터넷고등학교 다문화 골든벨 2등 / TAPIE interview acceptance.", "선린인터넷고등학교 다문화 골든벨 2등 / TAPIE 면접 합격."],
        ["온 가족 북웨이브 100일 챌린지 수상 / 서울로봇고등학교 영재교육원 수료 and top award.", "온 가족 북웨이브 100일 챌린지 수상 / 서울로봇고등학교 영재교육원 수료 및 최우수상."],
        ["Project Lab", "프로젝트 기록"],
        ...
        ["Travel web page project for Korean tourism packages and itinerary pages.", "한국 관광 상품과 여행 일정을 소개하는 여행 웹페이지 프로젝트입니다."],
        ["Tourism", "관광"],
        ["Chemistry educational site created through AI-assisted exploration.", "AI의 도움을 받아 탐구하며 제작한 화학 교육 사이트입니다."],
        ["Education", "교육"],
        ["Chemistry", "화학"],
