(() => {
    ...
    const messages = [
        ...
        ["First project experience", "첫 프로젝트 경험 - 서울동행플라자 키오스크"],
        ["First project experience", "2026 춘천시 해커톤 대회 장려상"],
        ["First project experience", "2026 춘천시 해커톤 대회 장려상"],
        ...
        ["KNHT", "한국사능력검정시험"],
        ["KNHT", "2026 춘천시 데이터활용 해커톤"],
        ["KNHT", "장려상"],
        ["Software Share Festival", "2026 선린 소프트웨어나눔축제"],
        ["Software Share Festival", "TAPIE (테이피)"],
        ["More Growth", "앞으로의 성장"],
        ["New activities and certificates will be added here.", "새로운 활동과 자격증을 이곳에 기록할 예정입니다."],
        ["Achievement", "성과"],
        ["Awards", "수상 내역"],
        ["School", "학교"],
        ["선린인터넷고등학교 다문화 골든벨 2등 / TAPIE interview acceptance.", "2026 춘천시 데이터활용 해커톤 장려상"],
        ...
        ["2025 KMF Scholarship", "2024 서울교육대학교 이중언어페스티벌 장려상"],
        ["Project Lab", "프로젝트 기록"],
