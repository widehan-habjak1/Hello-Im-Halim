(() => {
    ...
    const messages = [
        ...
        ["Python, HTML, CSS, JavaScript, and web development basics.", "Python, HTML, CSS, JavaScript와 웹 개발 기초를 공부하는 중."],
        ["Scientific Thinking", "과학적 사고"],
        ["Strong curiosity around physics concepts, algorithms, and systems.", "물리학, 알고리즘, 시스템 원리에 대한 깊은 호기심."],
        ["Language Skills", "언어 능력"],
        ["Fluent in Indonesian, English, and Korean.", "인도네시아어, 영어, 한국어 사용."],
        ["Timeline", "타임라인"],
        ...
        ["Introducing who I am, what I care about, and where I want to grow next.", "어떤 사람인지, 무엇에 관심이 있는지, 앞으로의 성장 방향을 소개하는 페이지."],
        ["Software and AI learner", "소프트웨어와 AI를 배우는 학생"],
        ["Introduce Me", "자기소개"],
        ["I am a Korean-born Indonesian Muslim student who keeps learning through coding, science, design, and real projects. I study in Korea and also stay connected to Indonesian education and culture.", "한국에서 태어난 인도네시아인 무슬림 학생. 코딩, 과학, 디자인과 실제 프로젝트를 통해 배우는 중. 한국에서 공부하며 인도네시아의 교육과 문화도 이어가는 중."],
        ["Traits", "나의 성향"],
        ["Curious, multilingual, persistent, and comfortable learning new tools. I like turning rough ideas into something people can actually use.", "호기심이 많고 3개 국어를 사용하는 사람. 새로운 도구를 끈기 있게 배우는 중. 막연한 아이디어를 실제로 사용할 수 있고 선한 영향력을 만드는 결과물로 바꾸는 일."],
        ["Vision", "나의 목표"],
        ["My goal is to enter a top university and build skills in computer science, AI, and meaningful technology for people.", "우수한 대학에 진학해 컴퓨터공학과 인문 계열을 복수 전공하고, AI와 인문학을 배우는 것이 목표."],
        ["Interests", "관심 분야"],
        ["#AI", "#AI"],
        ["#History", "#역사"],
        ["#UI/UX", "#UI/UX"],
        ...
        ["#Systems", "#시스템"],
        ["#Dakwah", "#다와"],
        ["Proficient in Python and web development fundamentals.", "파이썬과 웹 프론트 기초를 익히고 프로젝트에 활용하는 중."],
        ["Strong understanding of physics concepts and problem-solving patterns.", "물리·과학 개념과 문제 해결 방식의 이해와 적용."],
        ...
        ["A collection of career-class worksheets and exploration notes.", "진로 시간 학습지와 탐색 기록을 모아두는 페이지."],
        ...
        ["No worksheets yet. Add your class handouts or worksheets using the form above.", "아직 추가된 학습지 없음. 위 폼에서 수업 프린트나 학습지 추가."],
        ["No worksheets in {semester} / {category}.", "{semester} / {category}에 추가된 학습지 없음."],
        ["Open Item", "자료 열기"],
        ...
        ["This worksheet is saved as a note without a file.", "파일 없이 기록만 저장된 학습지."],
        ["The file name is saved, but the file data is missing. Please attach the same file again.", "파일 이름은 저장되어 있지만 파일 데이터 없음. 같은 파일을 다시 첨부."],
        ["Missing file cards were removed", "파일이 없는 자료 카드 정리 완료."],
        ["Could not open this file", "파일을 열 수 없음."],
        ["Could not save this file in the browser", "브라우저에 파일을 저장하지 못함."],
        ["Browser storage is full. Try a smaller file.", "브라우저 저장 공간 부족. 더 작은 파일로 시도."],
        ["Archive backup downloaded", "자료실 백업 다운로드 완료."],
        ["Archive restored", "자료실 백업 복원 완료."],
        ["Could not export this archive", "자료실 백업을 내보내지 못함."],
        ["Could not restore this archive", "자료실 백업을 복원하지 못함."],
        ["Worksheet added to Career Archive", "진로 자료실에 학습지 추가 완료."],
        ["{label} selected", "{label} 선택됨"],
        ["{semester} opened", "{semester} 자료 열기 완료."],
        ["School activities, club experiences, technical skills, and certificates.", "학교 활동, 동아리 경험, 기술 역량과 자격증을 정리하는 페이지."],
        ["Activity Tabs", "활동 분류"],
        ...
        ["TAPIE", "TAPIE (테이피)"],
        ["More Growth", "앞으로의 성장"],
        ["New activities and certificates will be added here.", "새로운 활동과 자격증을 기록할 공간."],
        ["Achievement", "성과"],
        ["Awards", "수상 내역"],
        ["School", "학교"],
        ...
        ["Project Lab", "프로젝트 기록"],
        ["Research, school projects, and personal web projects collected in one place.", "탐구 활동, 학교 프로젝트, 개인 웹 프로젝트를 한곳에 모은 공간."],
        ["Researches", "탐구 활동"],
        ["School Projects", "학교 프로젝트"],
        ["My Projects", "개인 프로젝트"],
        ["Accessible kiosk interface project designed for a school project experience.", "학교 프로젝트로 제작한 접근성 중심 키오스크 인터페이스."],
        ["Travel web page project for Korean tourism packages and itinerary pages.", "무슬림 관광객을 위한 한국 관광 상품과 여행 일정 웹페이지 프로젝트."],
        ["Tourism", "관광"],
        ["Chemistry educational site created through AI-assisted exploration.", "바이브코딩으로 제작한 화학 교육 사이트."],
        ["Education", "교육"],
        ["Chemistry", "화학"],
        ["First Vibe-Coded Web", "첫 바이브 코딩 웹사이트"],
        ["AI Assisted", "AI 활용"],
        ["First python project, as my research paper in middle school.", "중학교 탐구 보고서를 위해 만든 첫 Python 프로젝트."],
        ...
        ["AI-written summary", "AI가 작성한 요약"],
        ["Activities", "당시 활동"],
        ["Lessons learned", "배운 점"],
        ["I learned about UI structure, user flows, and collaboration through the Seoul Donghaeng Plaza kiosk project.", "서울동행플라자 키오스크 프로젝트를 통해 배운 UI 구조, 사용자 흐름과 협업 방식."],
        ["Turning an idea into code taught me that a clear structure for real users matters as much as appearance.", "아이디어를 코드로 옮기며 배운 점. 화면의 예쁨만큼 실제 사용자가 쉽게 이해할 수 있는 구조가 중요하다는 것."],
        ["Mobile", "모바일"],
        ["Responsive Preview", "반응형 미리보기"],
        ["Mobile layout preview", "모바일 레이아웃 미리보기"],
        ["{date} journey selected", "{date} 성장 기록 선택."],
        ...
        ["2026.06 First project experience - Seoul Donghaeng Plaza kiosk", "2026.06 첫 프로젝트 경험 - 서울동행플라자 키오스크"],
        ...
        ["I learned that role sharing, quick decisions, and the ability to finish and present matter as much as a good idea.", "해커톤을 통해 배운 점. 좋은 아이디어만큼 중요한 역할 분담, 빠른 판단과 끝까지 발표하는 실행력."],
        ["I compared CPU and GPU roles, parallel processing, and system architecture to understand how computers handle work.", "CPU와 GPU의 역할, 병렬 처리와 시스템 구조를 비교하며 컴퓨터의 작업 처리 방식을 탐구한 기록."],
        ["I learned that understanding internal principles and structures leads to more precise use of technology.", "도구의 내부 원리와 구조를 이해하며 배운 점. 기술을 더 정확하게 활용하는 방법."],
        ["I designed and tested a small AI agent that can understand a goal, use tools, and continue a task.", "목표를 이해하고 도구를 사용하며 작업을 이어가는 작은 AI agent 프로토타입 설계와 테스트."],
        ["Building with AI requires more than prompts: the goal, context, and verification process all need to be designed.", "AI로 무언가를 만들 때 필요한 것. 프롬프트를 넘어 목표, context와 검증 과정까지 함께 설계하는 일."],
        ["Career worksheets helped me start organizing my interests and goals.", "진로 학습지를 통해 정리하기 시작한 관심 분야와 목표."],
        ["Writing down vague interests makes it easier to choose the next step.", "막연한 관심사를 글로 정리하며 배운 점. 다음 행동을 더 쉽게 선택하는 방법."],
        ["I focused more on building interfaces with HTML, CSS, and JavaScript.", "HTML, CSS, JavaScript로 화면을 구성하는 방법에 집중한 기록."],
        ["Design and coding work together to create one user experience.", "디자인과 코딩은 하나의 사용자 경험을 만드는 과정이라는 점."],
        ["I studied how to break interfaces into components and manage state.", "컴포넌트 단위로 화면을 나누고 상태를 관리하는 방식에 대한 학습."],
        ["Breaking a large interface into smaller parts makes it easier to build.", "큰 화면을 작은 단위로 나누며 배운 점. 더 차분하게 만드는 방법."],
        ["I explored UI structure and user flows while building the Seoul Donghaeng Plaza kiosk project.", "서울동행플라자 키오스크 프로젝트에서 고민한 UI 구조와 사용자 흐름."],
        ["A project needs a structure that real people can use easily, as well as a good-looking interface.", "프로젝트에 필요한 것. 예쁜 화면과 실제 사람이 쉽게 사용할 수 있는 구조."],
        ["I expanded my exploration to AI, algorithms, and computer architecture.", "AI, 알고리즘, 컴퓨터 구조로 넓어진 탐구 주제."],
        ["Using tools well also requires understanding their principles and structure.", "도구의 원리와 구조를 함께 이해하며 배운 점."],
        ["I organized my records on the web while developing HIH into a career digital portfolio.", "HIH를 진로 디지털 포트폴리오로 발전시키며 웹으로 정리한 기록."],
        ["Silver Award at Yeongwon Middle School Science Fair.", "영원중학교 교내 과학전람회 은상."],
        ["Designing my own growth record makes my direction clearer.", "나의 성장 과정을 직접 디자인하며 선명해진 방향."],
        ["Make Your Page", "나만의 페이지 만들기"],
        ["A simple request form for people who want a small personal bio site.", "개인 소개 사이트를 원하는 사람을 위한 간단한 제작 요청 양식."],
        ["Bio-site Builder", "소개 사이트 제작"],
        ["Share your name, title, preferred layout, and the features you want to show. This page keeps the request simple and clean.", "이름, 사이트 제목, 원하는 레이아웃과 기능을 입력하는 간단한 제작 요청 양식."],
        ["REQUEST FORM", "제작 요청서"],
        ...
        ["Bio-site request saved in this browser", "이 브라우저에 제작 요청 저장 완료."],
