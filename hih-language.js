(() => {
    ...
    const messages = [
        ...
        ["I started organizing my interests and goals through career worksheets.", "진로 학습지를 통해 관심 분야와 목표를 정리하기 시작했습니다."],
        ["Writing down vague interests makes it easier to choose the next step.", "막연한 관심사를 글로 정리하면 다음 행동을 더 쉽게 정할 수 있다는 점을 배웠습니다."],
        ["I joined the Chuncheon Data Utilization Hackathon and turned an idea into a service with my team under a tight deadline.", "팀과 함께 춘천시 데이터활용 해커톤에 참여하며 제한된 시간 안에 아이디어를 서비스로 구체화했습니다."],
        ["I learned that role sharing, quick decisions, and the ability to finish and present matter as much as a good idea.", "좋은 아이디어뿐 아니라 역할 분담, 빠른 판단, 끝까지 발표하는 실행력이 중요하다는 점을 배웠습니다."],
        ["I compared CPU and GPU roles, parallel processing, and system architecture to understand how computers handle work.", "CPU와 GPU의 역할, 병렬 처리, 시스템 구조를 비교하며 컴퓨터가 작업을 처리하는 방식을 탐구했습니다."],
        ["I learned that understanding internal principles and structures leads to more precise use of technology.", "도구를 사용하는 것을 넘어 내부 원리와 구조를 이해해야 더 정확하게 기술을 활용할 수 있다는 점을 배웠습니다."],
        ["I designed and tested a small AI agent that can understand a goal, use tools, and continue a task.", "AI agent가 목표를 이해하고 도구를 사용하며 작업을 이어가는 작은 프로토타입을 설계하고 테스트했습니다."],
        ["Building with AI requires more than prompts: the goal, context, and verification process all need to be designed.", "AI로 무언가를 만들 때는 프롬프트뿐 아니라 목표, context, 검증 과정까지 함께 설계해야 합니다."],
